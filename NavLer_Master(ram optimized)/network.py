from ram_optimized.def_layers import *
...
class GoogLeNet(Network):
    def setup(self):
        #with tf.device("/gpu:0"):
            ...
            # Modified the output branch to a 6 dimension(3+3) vector.
            (self.feed('icp3_out0',
                       'icp3_out1',
                       'icp3_out2',
                       'icp3_out3')
            ...
            (self.feed('cls1_fc1_pose')
                 .fc(3, relu=False, name='cls1_fc_pose_wpqr'))
            ...
            (self.feed('cls2_fc1')
                 .fc(3, relu=False, name='cls2_fc_pose_wpqr'))
        ...
        #with tf.device("/gpu:1"):
            ...
            (self.feed('cls3_fc1_pose')
                 .fc(3, relu=False, name='cls3_fc_pose_wpqr'))